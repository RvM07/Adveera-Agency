...
const Footer = () => {
  return (
    <footer className="w-full bg-[#141414]">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-8 md:px-10">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-[1.3fr_0.8fr_0.9fr]">
          <div>
          ...
          <div>
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full bg-orange-500 px-4 py-2 text-sm font-medium text-white transition hover:bg-orange-400"
            >
              Start a project
